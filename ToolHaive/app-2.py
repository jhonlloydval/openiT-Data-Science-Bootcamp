...
──────────────────────────────────────────────────────────────────────────────
Entry point for the Streamlit app. Renders the dark-navy hero, feature chips,
preview tool strip, and stats row — matching the approved toolhive_design.html.

All styling is sourced from utils/ui.py (zero CSS lives in this file).
──────────────────────────────────────────────────────────────────────────────
"""
...
# ── Inject fonts + CSS (must be first) ───────────────────────────────────────
inject_styles()
...
<div class="th-page" style="background:#0A1628;">
  ...
  <section class="th-hero">
    ...
    <div class="th-hero-content">
      ...
      <div class="th-hero-cta-row">
        <a class="th-btn-hero" href="/Tools_Library">
        ...
        <button class="th-btn-ghost">Learn More</button>
      </div>
  ...
  <!-- ═══════════════════  PREVIEW STRIP  ═══════════════════ -->
  <section class="th-preview">
    <div class="th-preview-label">Available tools · Click any to launch</div>
    <div class="th-preview-grid">

      <a class="th-preview-card" href="/Tools_Library" style="text-decoration:none;">
    ...
    <div class="th-stats-row">
      <div>
        <div class="th-stat-num">8</div>
        <div class="th-stat-label">Specialized Tools</div>
      </div>
      <div>
        <div class="th-stat-num">100%</div>
        <div class="th-stat-label">Local · Private</div>
      </div>
      <div>
        <div class="th-stat-num">0</div>
        <div class="th-stat-label">Prompt Eng. Required</div>
      </div>
      <div>
        <div class="th-stat-num">∞</div>
        <div class="th-stat-label">Custom Tools</div>
      </div>
    </div>
